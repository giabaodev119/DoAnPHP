...
<html lang="vi">
  <head>
    ...
    <title>Admin Dashboard - Thêm Banner Mới</title>
              ...
              <div class="col-12">
                <div class="form-container">
                  <div class="form-header">
                    <h2><i class="fas fa-plus-circle me-2"></i>Thêm Banner Mới</h2>
                    <p class="text-muted">Thêm banner quảng cáo mới vào hệ thống</p>
                  </div>
                  
                  <?php if (isset($_GET['error']) && $_GET['error'] == 1): ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                      <i class="fas fa-exclamation-circle me-2"></i>Có lỗi xảy ra khi thêm banner. Vui lòng thử lại!
                  ...
                  <form method="POST" enctype="multipart/form-data" id="bannerForm">
                    ...
                    <div class="mb-4">
                      <label class="form-label"><i class="fas fa-image me-1"></i> Hình ảnh banner</label>
                      <label for="image" class="custom-file-upload">
                        <i class="fas fa-cloud-upload-alt fa-2x mb-3" style="color: #2575fc;"></i>
                        <p class="mb-1">Kéo thả hình ảnh vào đây hoặc click để chọn</p>
                        <small class="text-muted">(Chỉ hỗ trợ file ảnh: JPG, PNG, GIF. Kích thước tối đa: 5MB)</small>
                      </label>
